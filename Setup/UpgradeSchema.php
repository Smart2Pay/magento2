...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    public function upgrade( SchemaSetupInterface $setup, ModuleContextInterface $context )
    {
        ...
        if( version_compare( $current_version, '3.0.0' ) < 0 )
            $this->_upgrade_3_0_0( $setup, $context );

        if( version_compare( $current_version, '3.0.1' ) < 0 )
            $this->_upgrade_3_0_1( $setup, $context );
    ...
    //
    private function _upgrade_2_1_0( SchemaSetupInterface $setup, ModuleContextInterface $context )
    {
        //
        //  Methods table
        //
        ...
        $setup->getConnection()->addColumn( $methods_configured_table, 'environment',
            [
                'after' => 'id',
        ...
        $setup->getConnection()->addIndex( $methods_configured_table,
        ...
        $setup->getConnection()->addColumn( $countries_methods_table, 'environment',
            [
                'after' => 'id',
                'type' => \Magento\Framework\DB\Ddl\Table::TYPE_TEXT,
                'length' => 50,
        ...
        $setup->getConnection()->addIndex( $countries_methods_table,
        ...
        $setup->getConnection()->addColumn( $logs_table, 'transaction_id',
            [
                'after' => 'log_type',
        ...
        $setup->getConnection()->addIndex( $logs_table,
    ...
    //
    private function _upgrade_3_0_0( SchemaSetupInterface $setup, ModuleContextInterface $context )
    {
        //
        //  logs table
        //
        ...
        $setup->getConnection()->changeColumn( $logs_table, 'transaction_id', 'transaction_id',
            [
                'after' => 'log_type',
                'type' => \Magento\Framework\DB\Ddl\Table::TYPE_TEXT,
                'length' => 100,
    ...
    //
    private function _upgrade_3_0_1( SchemaSetupInterface $setup, ModuleContextInterface $context )
    {
        //
        //  transactions table
        //
        ...
        $setup->getConnection()->addColumn( $transactions_table, '3dsecure',
                                            [
                                                'after' => 'extra_data',
                                                'type' => \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
                                                'nullable' => true,
    ...
    //
    private function _upgrade_future_version( SchemaSetupInterface $setup, ModuleContextInterface $context )
    {
        //
        //  Surcharge
        //
        ...
        $setup->getConnection()->addColumn( $setup->getTable( 'quote_payment' ),
                                            's2p_surcharge_amount', [ 'type' => \Magento\Framework\DB\Ddl\Table::TYPE_DECIMAL, 'default' => 0, 'length' => '(10,2)', 'comment' => 'Surcharge amount' ]
        );
        $setup->getConnection()->addColumn( $setup->getTable( 'quote_payment' ),
                                            's2p_surcharge_base_amount', [ 'type' => \Magento\Framework\DB\Ddl\Table::TYPE_DECIMAL, 'default' => 0, 'length' => '(10,2)', 'comment' => 'Surcharge base amount' ]
        ...
        $setup->getConnection()->addColumn( $setup->getTable( 'sales_order_payment' ),
                                            's2p_surcharge_amount', [ 'type' => \Magento\Framework\DB\Ddl\Table::TYPE_DECIMAL, 'default' => 0, 'length' => '(10,2)', 'comment' => 'Surcharge amount' ]
        );
        $setup->getConnection()->addColumn( $setup->getTable( 'sales_order_payment' ),
                                            's2p_surcharge_base_amount', [ 'type' => \Magento\Framework\DB\Ddl\Table::TYPE_DECIMAL, 'default' => 0, 'length' => '(10,2)', 'comment' => 'Surcharge base amount' ]
        ...
        $setup->getConnection()->addColumn( $setup->getTable( 'sales_invoice' ),
                                            's2p_surcharge_amount', [ 'type' => \Magento\Framework\DB\Ddl\Table::TYPE_DECIMAL, 'default' => 0, 'length' => '(10,2)', 'comment' => 'Surcharge amount' ]
        );
        $setup->getConnection()->addColumn( $setup->getTable( 'sales_invoice' ),
                                            's2p_surcharge_base_amount', [ 'type' => \Magento\Framework\DB\Ddl\Table::TYPE_DECIMAL, 'default' => 0, 'length' => '(10,2)', 'comment' => 'Surcharge base amount' ]
